    ...
    <div className="relative">
      ...
      <div className="w-[100vw] mt-4 flex justify-center items-center align-middle h-[98vh] md:h-[100vh] bg-stone-900 bg-fixed p-6">
        <div
          ...
          className="h-[36rem] mt-20 md:h-[48rem] group flex flex-col overflow-hidden justify-start   gap-4 mx-auto px-8 relative text-start w-full md:w-9/12 pt-80 rounded-3xl border  border-stone-900/25 hover:border-stone-950/60 hover:shadow-md bg-stone-900/25 backdrop-blur-sm"
        >
          <AnimatePresence>
            {hovered && (
              <motion.div
