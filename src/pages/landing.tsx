...
export default function Hero(props?: LoadingProps) {
  ...
  const items = [
    { title: "Impacto climático positivo", subtitle: "Reforestación, captura de carbono y manejo de agua.", image: "/img/landing/forest2.jpg" },
    { title: "Amamos la tierra", subtitle: "Cuidamos el suelo, la biodiversidad y la comunidad.", image: "/img/landing/land2.jpg" },
    { title: "Impacto social real", subtitle: "Generamos empleo digno en zonas rurales", image: "/img/landing/social_impact.jpg" },
    { title: "Artesanos de la madera", subtitle: "Nuestro equipo transforma la madera con conocimiento y respeto.", image: "/img/landing/climate2.jpg" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
        {items.map((item, idx) => (
          <div key={idx} className="relative group overflow-hidden h-[500px] cursor-pointer">
            <img src={item.image} alt={item.title} className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500 ease-in-out" />
