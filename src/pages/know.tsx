...
interface TimelineItem {
    ...
    content: string
    bgColor: string
    images?: string[] // ⬅️ AHORA SON X IMÁGENES
}
...
const timelineData: TimelineItem[] = [
    {
        ...
        bgColor: '#BADF72',
        images: [
            '/img/about_us/hito1_1.jpg',
            '/img/about_us/hito1_2.jpg',
            '/img/about_us/hito1_3.jpg',
        ],
    },
    {
        date: '2011 – 2013',
        ...
        bgColor: '#394930',
        images: [
            '/img/about_us/hito2_1.jpg',
            '/img/about_us/hito2_2.jpg',
            '/img/about_us/hito2_3.jpg',
            '/img/about_us/hito2_4.jpg',
        ],
    },
    {
        date: '2013 – 2015',
    ...
    },
    {
        ...
        bgColor: '#b09bff',
        images: [
            '/img/about_us/hito4_1.jpg',
            '/img/about_us/hito4_2.jpg',
            '/img/about_us/hito4_3.jpg',
        ],
    },
    {
        date: '2019 – 2021',
        ...
        bgColor: '#BADF72',
        images: [
            '/img/about_us/hito5_1.jpg',
            '/img/about_us/hito5_2.jpg',
            '/img/about_us/hito5_3.jpg',
            '/img/about_us/hito5_4.jpg',
            '/img/about_us/hito5_5.jpg',
        ],
    },
    {
        date: '2022 – Hoy',
        ...
        bgColor: '#b09bff',
        images: [
            '/img/about_us/hito6_1.jpg',
            '/img/about_us/hito6_2.jpg',
            '/img/about_us/hito6_3.jpg',
            '/img/about_us/hito6_4.jpg',
            '/img/about_us/hito6_5.jpg',
        ],
    },
]
    ...
    return (
        ...
        >
            ...
            {timelineData.map((item, i) => (
                <section
                    key={i}
                    className="relative isolate h-screen snap-start"
                ...
                >
                    ...
                    <div className="cloud five absolute -z-10" />
                    <div className="cloud six absolute -z-10" />
                    <div className="flex flex-col md:flex-row items-center h-full px-6 md:px-16">
                        {/* Texto */}
