  ...
  return (
    <div className="flex relative">
      ...
      <Timeline data={[
        {
          title:  '¿Quienes somos?',
          content: <div className="my-[5rem] mx-auto  bg-stone-900/50 transition-all hover:bg-stone-900/75  flex p-10 justify-center md:w-8/12 h-fit rounded-xl  backdrop-blur-sm text-white">
